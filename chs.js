...
var cnItems = {
    ...
    "The Galaxy Layer is disabled.": "Galaxy 层被禁用。",
    "The Galaxy Layer's atomic grid is now 2x2.": "Galaxy Layer 的原子网格现在是 2x2。",
    "The Galaxy Layer's starting generation speed is 100x faster, but drops exponentially.": "Galaxy Layer 的起始生成速度快了 100 倍，但呈指数下降。",
    ...
    "True AD": "真正的广告",
    "Unlock autobuyers for Booster Power Upgrades.": "为 Booster Power Upgrades 解锁 autobuyers。",
